 ...
 * <p>
 * Things to remember:
 *  - Assumes Spark calls hasNext() to check for elements, before calling next() to obtain them
 *  - Assumes hasNext() gets called atleast once.
 *  - Concrete Implementation is responsible for calling inputIterator.next() and doing the processing in computeNext()
 */
